<h1  align="center">
  <img src="https://i.ibb.co/YXyyPKy/class-js.png" alt="class-js" border="0">
</h1>
...
Welcome! 
This project was made in study about classes in JavaScript.
To achieve this goal, I made notes taking as examples the creation of Dog and Cat classes to a day care, to later create an Animal class as the parent class using the shared properties between the previous classes (Dog and Cat).
